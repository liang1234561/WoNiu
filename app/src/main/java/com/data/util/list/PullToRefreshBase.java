 ...
 * @author root
    ...
    public interface OnRefreshListener<V extends View> {
         ...
         * @param refreshView 刷新的View
         */
        void onPushUpToRefresh(final PullToRefreshBase<V> refreshView);
    }
    ...
    public void setScrollLoadEnabled_(boolean scrollLoadEnabled) {
        mScrollLoadEnabled = scrollLoadEnabled;
    }
    ...
    protected void startLoading() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPushUpToRefresh(PullToRefreshBase.this);
                }
            }, getSmoothScrollDuration());
        }
    }
