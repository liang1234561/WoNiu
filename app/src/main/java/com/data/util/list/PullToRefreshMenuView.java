 ...
 * @since 2013-8-15
 */
public class PullToRefreshMenuView extends PullToRefreshBase<SwipeMenuListView> implements OnScrollListener {
     ...
     */
    public PullToRefreshMenuView(Context context) {
        this(context, null);
    }
     ...
     * @param attrs attrs
     */
    public PullToRefreshMenuView(Context context, AttributeSet attrs) {
     ...
     */
    public PullToRefreshMenuView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected SwipeMenuListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        mListView = listView;
     //   mListView.setDivider(getResources().getDrawable(R.drawable.shape_divider_default));
        listView.setOnScrollListener(this);
        listView.setDivider(getResources().getDrawable(R.color.white));
        listView.setDividerHeight(Utils.dip2px(context, 1));
        return listView;
    }
